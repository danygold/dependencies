...
dependencies {
    ...
    implementation("org.apache.logging.log4j:log4j-slf4j2-impl:2.25.3") // tika-core slf4j2 logger
    ...
    testRuntimeOnly("org.junit.platform:junit-platform-launcher:6.0.2") // Gradle 9+
}
