...
dependencies {
    ...
    implementation("com.github.oshi:oshi-core-java11:6.8.1")

    implementation("org.jetbrains:annotations:26.0.2")
    implementation("com.google.errorprone:error_prone_annotations:2.38.0")

    implementation("com.puppycrawl.tools:checkstyle:10.24.0")

    testImplementation("org.testfx:testfx-junit5:4.0.18")
    testImplementation("org.hamcrest:hamcrest:3.0") // testfx-junit5 dependency
    testImplementation("org.junit.jupiter:junit-jupiter:5.12.2")
    testRuntimeOnly("org.junit.platform:junit-platform-launcher:1.12.2") // Gradle 9+
}
