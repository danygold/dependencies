...
dependencies {
    ...
    implementation("org.apache.logging.log4j:log4j-slf4j2-impl:2.24.1") // tika-core slf4j2 logger
    ...
    testRuntimeOnly("org.junit.platform:junit-platform-launcher:1.11.4") // Gradle 9+
}
